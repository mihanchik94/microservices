...
import ru.job4j.sservice.properties.KafkaProducerProperties;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public NewTopic getStudentByGradeBookNumberResponseTopic() {
        return TopicBuilder.name(kafkaProducerProperties.getGetStudentByGradeBookNumberResponseTopicName())
                .partitions(kafkaProducerProperties.getGetStudentByGradeBookNumberResponseTopicPartitions())
                .replicas(kafkaProducerProperties.getGetStudentByGradeBookNumberResponseTopicReplicas())
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
    }

    @Bean
    public NewTopic getAllStudentsRequestTopic() {
        return TopicBuilder.name(kafkaProducerProperties.getGetAllStudentsResponseTopicName())
                .partitions(kafkaProducerProperties.getGetAllStudentsResponseTopicPartitions())
                .replicas(kafkaProducerProperties.getGetAllStudentsResponseTopicReplicas())
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
    }
}